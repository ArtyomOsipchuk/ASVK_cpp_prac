...
Необходимо реализовать "обычный" генетический алгоритм согласно описанию из лекций В.А. Костенко (https://cloud.asvk.cs.msu.ru/s/j3wmxHFGcxKyyzB). Более детальное описание ГА, в т.ч. операций селекции, скрещивания и мутации, можно найти в материале: http://qai.narod.ru/Publications/tsoy_chapterGA.pdf
...
Начальная популяция: полностью случайно генерируется, вероятность того что в клетке "1" равна 0,75.
...
* _S3: турнирная селекция (см. http://qai.narod.ru/Publications/tsoy_chapterGA.pdf, пункт 9.3.3)_

Операция скрещивания:
* Х1: одноточечное скрещивание
* _Х2: двухточечное скрещивание_
...
Критерий останова: 50 итераций ГА (т.е. 50 смен популяций) подряд без улучшения значения оптимизируемого критерия *на лучшем из найденных решений*. То есть 50 итераций подряд не удалось найти решение с меньшим значением критерия, чем у запомненного лучшего из ранее найденных решений.
